...
void main()
{
    gl_Position = ProjectionMat * CameraMat * TransformMat * vec4(Pos.x, Pos.y, Pos.z, 1.0f);
    ...
    vs_out.outLightSpaceFragPos = LightProjectionViewMat * TransformMat * vec4(Pos, 1.0);
}